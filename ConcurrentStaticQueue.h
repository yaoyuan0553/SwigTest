...
#pragma once
#ifndef SWIGTEST_CONCURRENTSTATICQUEUE_H
#define SWIGTEST_CONCURRENTSTATICQUEUE_H
...
public:
     ...
     */
    ConcurrentStaticQueue(size_t maxSize, int writeAhead, int maxConsumers) :
...
template <typename T>
using CSQueue = ConcurrentStaticQueue<T>;


#endif //SWIGTEST_CONCURRENTSTATICQUEUE_H
